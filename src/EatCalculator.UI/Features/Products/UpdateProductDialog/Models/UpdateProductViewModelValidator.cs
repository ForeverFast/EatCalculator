...
namespace EatCalculator.UI.Features.Products.UpdateProductDialog.Models
{
    internal sealed class UpdateProductViewModelValidator : BaseValidator<UpdateProductViewModel>
    {
        ...
        private bool CheckPFC(UpdateProductViewModel model)
