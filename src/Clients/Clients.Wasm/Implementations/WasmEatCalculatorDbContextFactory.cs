...
namespace Clients.Wasm.Implementations
{
    public class WasmEatCalculatorDbContextFactory : IEatCalculatorDbContextFactory
    {
        #region Injects
        ...
        public WasmEatCalculatorDbContextFactory(
            ...
            IJSRuntime jSRuntime)
        {
            ...
            _dbFilename = $"{_eatCalculatorDbContextSettings.DbName}.db";
        ...
        private string _dbFilename = "EatCalculator.db";
